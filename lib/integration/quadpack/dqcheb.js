...
exports.dqcheb = dqcheb;
/* eslint-disable no-labels */
/* eslint-disable no-fallthrough */
function dqcheb(x, fval, cheb12, cheb24) {
  var alam = void 0,
      alam1 = void 0,
      alam2 = void 0,
      part1 = void 0,
  ...
  mainExecutionLoop: while (true) {
    switch (goToLabel) {
      case 0:
        ...
        for (i = 2; i <= 12; i++) {
          cheb12[i - 1] = cheb12[i - 1] * alam;
        }
        alam = 0.5e+00 * alam;
        cheb12[0] = cheb12[0] * alam;
        cheb12[12] = cheb12[12] * alam;
        for (i = 2; i <= 24; i++) {
          cheb24[i - 1] = cheb24[i - 1] * alam;
        }
        cheb24[0] = 0.5e+00 * alam * cheb24[0];
        cheb24[24] = 0.5e+00 * alam * cheb24[24];
      default:
        break mainExecutionLoop;
    }
  }
  return [cheb12, cheb24];
}