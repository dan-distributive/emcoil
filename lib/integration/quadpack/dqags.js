...
var _dqagse3 = require('./dqagse.js');

var _xerror = require('./xerror.js');

function dqags(f, a, b, epsabs, epsrel, result, abserr, neval, ier, limit, lenw, last, iwork, work) {
  var lvl = void 0,
      l1 = void 0,
      l2 = void 0,
      l3 = void 0;
  ...
  mainExecutionLoop: while (true) {
    switch (goToLabel) {
      case 0:
        ...
        var _dqagse = (0, _dqagse3.dqagse)(f, a, b, epsabs, epsrel, limit, result, abserr, neval, ier, work[0], work[l1 - 1], work[l2 - 1], work[l3 - 1], iwork, last);
        ...
        console.log('dqags not fully translated, the work array doesn\'t have all data in it.');
        //
      ...
      case 10:
        if (ier === 6) lvl = 1;
        if (ier !== 0) (0, _xerror.xerror)('abnormal return from dqags', 26, ier, lvl);
      default:
